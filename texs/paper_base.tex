...
When the token $sy_{m+1}$ is the EOF token, generating process is stopped and the sequence $ [sy_1, \dots sy_m]$ is returned as the inference result.
