...
extractbb bleu.png && extractbb edit_dist.png && extractbb ast_lens.png && extractbb c_lens.png && extractbb ast_zu.png && extractbb encoder.png && extractbb decoder.png &&
